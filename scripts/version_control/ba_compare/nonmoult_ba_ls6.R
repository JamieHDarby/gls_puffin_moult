...
nonmoult.ba.ls.6[[1]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.6[[2]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.6[[3]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.6[[4]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.6[[5]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.6[[6]] <- ba.nonmoult.1[2,1]

unlist(nonmoult.ba.ls.6)
