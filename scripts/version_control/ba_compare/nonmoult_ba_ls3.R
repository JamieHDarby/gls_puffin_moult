...
nonmoult.ba.ls.3[[1]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.3[[2]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.3[[3]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.3[[4]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.3[[5]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.3[[6]] <- ba.nonmoult.1[2,1]

unlist(nonmoult.ba.ls.3)
