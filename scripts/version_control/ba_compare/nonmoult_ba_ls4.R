...
nonmoult.ba.ls.4[[1]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.4[[2]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.4[[3]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.4[[4]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.4[[5]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.4[[6]] <- ba.nonmoult.1[2,1]

unlist(nonmoult.ba.ls.4)
