...
nonmoult.ba.ls.1[[1]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.1[[2]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.1[[3]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.1[[4]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.1[[5]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.1[[6]] <- ba.nonmoult.1[2,1]

unlist(nonmoult.ba.ls.1)
