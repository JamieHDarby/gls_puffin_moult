...
nonmoult.ba.ls.7[[1]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.7[[2]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.7[[3]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.7[[4]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.7[[5]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.7[[6]] <- ba.nonmoult.1[2,1]

unlist(nonmoult.ba.ls.7)
