...
nonmoult.ba.ls.2[[1]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.2[[2]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.2[[3]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.2[[4]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.2[[5]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.2[[6]] <- ba.nonmoult.1[2,1]

unlist(nonmoult.ba.ls.2)
