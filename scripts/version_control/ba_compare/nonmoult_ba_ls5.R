...
nonmoult.ba.ls.5[[1]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.5[[2]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.5[[3]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.5[[4]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.5[[5]] <- ba.nonmoult.1[2,1]
...
nonmoult.ba.ls.5[[6]] <- ba.nonmoult.1[2,1]

unlist(nonmoult.ba.ls.5)
